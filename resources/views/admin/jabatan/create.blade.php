        ...
        @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_jabatan" id="kode_jabatan" placeholder="kode jabatan" value="{{ old('kode_jabatan') }}" required>
                        @error('kode_jabatan')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" placeholder="nama jabatan" value="{{ old('nama_jabatan') }}" required>
                        @error('nama_jabatan')
                        <span class="text-danger">
                          {{ $message }}
                        </span>
