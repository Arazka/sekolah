        ...
        @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_mapel" id="kode_mapel" placeholder="kode mapel" value="{{ old('kode_mapel') }}" required>
                        @error('kode_mapel')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_mapel" id="nama_mapel" placeholder="nama mapel" value="{{ old('nama_mapel') }}" required>
                        @error('nama_mapel')
                        <span class="text-danger">
                          {{ $message }}
                        </span>
